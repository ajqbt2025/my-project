    ...
    sections: [
      {
        ...
        points: [
          ...
          "Enter Beneficiary Name, Transaction ID and Date.",
          "Payment once made is non-refundable.",
          "Based on the data we collect from you, we will prepare your Shajrah Certificate.",
          "After the payment is completed, your Shajrah Certificate will be available in the Certificate Management section within 7 to 15 days."
        ]
      }
    ],
    footer: "Please download and print this form for your records.",
    ...
    sections: [
      {
        ...
        points: [
          ...
          "Next बटन दबाने से पहले सभी विवरण जांच लें।",
          "सभी फ़ील्ड अनिवार्य हैं।",
          "सबसे पहले अपना पूरा नाम दर्ज करें।",
          "केवल अपने वास्तविक पिता का पूरा नाम दर्ज करें।",
          "कम से कम चार पीढ़ियों के नाम क्रम से दर्ज करें।",
          "कम से कम चार पूर्वजों के पहचान पत्र (ID Proof) अपलोड करें।",
          "₹28 का भुगतान अनिवार्य है।",
          "UPI या QR Code के माध्यम से भुगतान करें।",
          "Beneficiary Name, Transaction ID और तारीख दर्ज करें।",
          "एक बार किया गया भुगतान वापस नहीं किया जाएगा।",
          "आपके द्वारा प्रदान किए गए डेटा के आधार पर आपका शजरा प्रमाणपत्र तैयार किया जाएगा।",
          "भुगतान पूरा होने के बाद 7 से 15 दिनों के भीतर आपका शजरा प्रमाणपत्र Certificate Management सेक्शन में उपलब्ध होगा।"
        ]
      }
    ],
    footer: "कृपया इस फॉर्म को डाउनलोड कर प्रिंट अवश्य निकालें।",
    ...
    sections: [
      {
        ...
        points: [
          "تمام خانے غور سے اور احتیاط کے ساتھ پُر کریں۔",
          "Next بٹن دبانے سے پہلے تمام معلومات کی جانچ کریں۔",
          "تمام خانے پُر کرنا لازمی ہے۔",
          "سب سے پہلے اپنا پورا نام درج کریں۔",
          "صرف اپنے حقیقی والد کا پورا نام درج کریں، سرپرست کا نام درج نہ کریں۔",
          "کم از کم چار نسلوں کے نام ترتیب سے درج کریں۔",
          "کم از کم چار اجداد کے شناختی ثبوت اپلوڈ کریں۔",
          "28 روپے کی ادائیگی لازمی ہے۔",
          "UPI یا QR Code کے ذریعے ادائیگی کریں۔",
          "Beneficiary Name، Transaction ID اور تاریخ درج کریں۔",
          "ایک بار کی گئی ادائیگی ناقابلِ واپسی ہوگی۔",
          "آپ سے حاصل کیے گئے ڈیٹا کی بنیاد پر آپ کے لیے شجرہ سرٹیفکیٹ تیار کیا جائے گا۔",
          "ادائیگی مکمل ہونے کے بعد 7 سے 15 دن کے اندر آپ کا شجرہ سرٹیفکیٹ Certificate Management سیکشن میں دستیاب ہوگا۔"
        ]
      }
    ],
